                    ...
                    <div class="row">
                        <div class="col-md-6 mx-auto">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-rounded" onchange="GetData(this)" required id="user" name="user">
                                    <option value="" selected disabled>Select Location</option>
                                    <?php
                                    foreach ($location->result() as $loc) {
                                        ?>
                                        <option <?= $UID == $loc->LOCID ? "selected" : ""; ?> value="<?= $loc->LOCID; ?>"><?= $loc->locationname . " (" . $loc->locationname . ")"; ?></option>
                                    <?php
                                }
                                ?>
                                </select>
