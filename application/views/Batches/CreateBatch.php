        ...
        <div class="card-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-5 col-md-4 col-12">
                            ...
                            <div class="input-group">
                                <select name="Printer" id="printers" class="form-control mb-3" required >
                                 ...
                                 <?php
                                    if($location == 'sanand' || $location == 'pune'|| $location == 'chakan' ||  $location == 'pantnagar' || $location == 'lucknow'  ){
                                        ?>
                    ...
                    <div class="row">
                        <!-- <div class="col-lg-3 col-md-6 col-12">
                            <label for="DPI">Select Printer Dpi</label>
                            <select class="form-control " name="PrinterDpi" id="PrinterDpi">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <label for="DPI">Select Printer Dpi</label>
                            <select id="PrinterDpi" name="PrinterDpi" class="form-control" required>
                                <option value="">Select Printer Dpi</option>
                            </select>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(function(){
            ...
            $("#Consignee").change(function(){
                var Consignee = $(this).val();
                $.ajax({
                    url: "<?= base_url('Consignee/GetDpiInfo')?>",
                    type: "POST",
                    data: {
                        Consignee: Consignee
                    },
...
<?php
    if(trim(strtolower($location)) == 'sanand' || trim(strtolower($location)) == 'jamshedpur' ||  trim(strtolower($location)) == 'pune' || trim(strtolower($location)) == 'chakan' || trim(strtolower($location)) == 'pantnagar'|| trim(strtolower($location)) == 'lucknow' || trim(strtolower($location)) == 'delhi' || trim(strtolower($location)) == 'hosur'){
     ?>
        <script>
