...
function sendData(myfile) {
	showLoading("Printing...");
	checkPrinterStatus(function (text) {
		if (text == "Ready to Print") {
			// var myfile = GetFile();
			selected_printer.send(myfile, printComplete, printerError);
		}
		else {
			printerError(text);
		}
...
$('#PrintLable-Sub').click(function (e) {
