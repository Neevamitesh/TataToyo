...
<div class="row">
    <div class="col-lg-12 mx-auto">
        <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Print Report</div>
            <div class="card-body">
                    ...
                    <table id="LiveData" class="table default-datatable table-bordered">
                        ...
                        <tbody>
                            <?php
                                if($isdata == 1){
                                    $c = 1;
                                    foreach($wcprint->result() as $verified){
                                        ?>
                                            <tr>
                                                <td><?= $c; ?></td>     
                                                <td><?= $verified->consigneename; ?></td>
                                                <td><?= $verified->productname; ?></td>
                                                <td><?= $verified->productcode; ?></td>
                                                <td><?= $verified->Quantity; ?></td>
...
<script>
    $("#sortform").submit(function(e){
        ...
        window.location.href = "<?= base_url(); ?>Reports/WCPrintReport/" + cmid+"/"+fdate+"/"+tdate;
    });
