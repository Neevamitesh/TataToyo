                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <!-- <select class="form-control " name="Location" id="Location" required> -->
                                ...
                                <?php
                                    foreach ($location->result() as $loc) {
                                        ?>
                                        <option value="<?= $loc->LOCID; ?>"><?= $loc->locationname ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 " id="SRMain">
                            ...
                            <br>
                            <input type="radio" name="SrAuto" class="m-2 mr-0" value="pro">By Product (Daily 6:30AM)
                            <br>
                            <input type="radio" name="SrAuto" class="m-2 mr-0" value="pro-12">By Product (Daily 12AM)
                            <br>
                            <input type="radio" name="SrAuto" class="m-2 mr-0" value="pro-year">By Product (Yearly)
                            <br>
                            <input type="radio" name="SrAuto" class="m-2 mr-0" value="pro-month">By Product (Monthly)
                            <br>
                            <input type="radio" name="SrAuto" class="m-2 mr-0" value="pro-week">By Product (Weekly)
                            <!-- <br> -->
                            <!-- <input type="radio" name="SrAuto" class="m-2 mr-0" value="con">By Consignee (Daily) -->
                        </div>
                    </div>
                </div>
                <div class="card-footer">
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    Info.Location.forEach((row)=>{
                        $('#EditConsignee #Location option[value='+row+']').prop('selected',true);    
                    });
