<?php
    class PreTran extends CI_Model{
        ...
        public function Available(){
            $this->db->select("ConsigneeMaster.*,locationmaster.locationname LOC"); //@@27092019
            $this->db->join('ConsigneeMaster', 'ConsigneeMaster.CMID = Preview.CMID AND ConsigneeMaster.isactive = 1');
            $this->db->join("locationmaster", "locationmaster.LOCID = ConsigneeMaster.location", "left");//@@27092019
