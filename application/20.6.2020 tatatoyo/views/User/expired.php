            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center error-pages">
                        ...
                        <h2 class="error-sub-title text-white">Your Subscription has been expired !</h2>

                        <p class="error-message text-white text-uppercase">Please contact to developer !</p>
