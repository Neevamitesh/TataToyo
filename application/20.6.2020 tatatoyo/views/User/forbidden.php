...
<!-- Mirrored from codervent.com/dashrock/white-admin/pages-403.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Jan 2019 13:48:19 GMT -->
<head>
  <meta charset="utf-8"/>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center error-pages">
                        ...
                        <p class="error-message text-white text-uppercase">Another User is Already Logged in !</p>
                        
                        <div class="mt-4">
                          <a href="<?= base_url(); ?>" class="btn btn-danger btn-round shadow-danger m-1">Back To Home </a>
                          <!-- <a href="javascript:void();" class="btn btn-outline-danger btn-round m-1">Previous Page </a> -->
                        </div>
                        <div class="mt-4">
                          <form action="<?= base_url(); ?>Auth/LogOutAll" method="post">
                            <input type="hidden" name="email" value="<?= $email; ?>">
                            <input type="hidden" name="password" value="<?= $password; ?>">
                            <button class="btn btn-primary btn-round shadow-primary m-1">Log out from all devices <i class="fa fa-unlock"></i> </button>
                          </form>
                        </div>
                        <div class="mt-4">
                            <p class="text-light">Copyright © <?= date('Y'); ?>  <span class="text-danger">Neev Soft Technologies </span>| All rights reserved.</p>
                        </div>
                           <hr class="w-50">
                        <!-- <div class="mt-2">
