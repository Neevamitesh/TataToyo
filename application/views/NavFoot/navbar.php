        ...
        <div class="simplebar-content" style="padding-bottom: 17px; margin-right: -17px;">
          ...
          <ul class="sidebar-menu do-nicescrol">
            ...
            <li class="reports">
              ...
              <ul class="sidebar-submenu">
              <li class="CreateBatchReport"><a href="<?= base_url("Reports/CreateBatchReport");?>"><i class="fa fa-long-arrow-right"></i> CreateBatch Report</a></li> 
                ...
                <li class="userlogreport"><a href="<?= base_url("Reports/VerifyBarcode");?>"><i class="fa fa-long-arrow-right"></i>VerifyBarcode Report</a></li>
                <li class="userlogreport"><a href="<?= base_url("Reports/EOLVerifyReport");?>"><i class="fa fa-long-arrow-right"></i>EOL Verify Report</a></li>
                <li class="userlogreport"><a href="<?= base_url("Reports/WCPrintReport");?>"><i class="fa fa-long-arrow-right"></i>WC Print Report</a></li>
                <li class="userlogreport"><a href="<?= base_url("Reports/WCErrorReport");?>"><i class="fa fa-long-arrow-right"></i>WC Error Report</a></li>
              </ul>
            </li>
            ...
            <li class="">
              ...
              <ul class="sidebar-submenu">
                ...
                <?php
                  if($role == "SuperAdmin" || $role[0] == "SuperAdmin"){
                ?>
                <li><a href="<?= base_url("Consignee/PrintBatch");?>"><i class="fa fa-long-arrow-right"></i> Asset Tag</a></li>
               
                <?php
              }
            ?>
             <?php //if(strtotime(date('Y-m-d')) < strtotime(date($TrialDate))){
                ?>
                <li><a href="<?= base_url("Verify");?>"><i class="fa fa-long-arrow-right"></i> Verify Barcode </a></li>
                <li><a href="<?= base_url("Verify/BarcodeReport");?>"><i class="fa fa-long-arrow-right"></i> Reports VerifyBarcode </a></li>
               <?php
                //} ?>
