...
class Products extends CI_Controller
{
    ...
    public function UploadProductsExcel(){
        ...
        $Path = "upload/Product{$this->CMID}/{$Result['file_name']}";
            ...
            if($FileType == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" || $FileType == "text/csv" || $FileType == "application/vnd.ms-excel" || $FileType == "application/octet-stream"){
                ...
                foreach($object->getWorksheetIterator() as $worksheet){
                    ...
                    for($row=2; $row<=$highestRow; $row++){
                        ...
                        $productname = $worksheet->getCellByColumnAndRow($proIndex, $row)->getValue();
                        $PARTNO = $worksheet->getCellByColumnAndRow($PartIndex, $row)->getValue();
                        $productData = array(
                            'CMID' => $consignee,
                            'productname' => $productname,
                            'productcode' => $PARTNO,
