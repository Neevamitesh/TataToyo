                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <select name="Location[]" multiple class="form-control"   name="Location" id="Location" required>
                         <!-- <select class="form-control " name="Location" id="Location" required> -->
                                <option value="">Select Location</option>
                                <?php
                                    foreach ($location->result() as $key=>$loc) {
                                        ?>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <br>
                            <input type="radio" name="SrAuto" class="m-2 mr-0" value="pro">By Product (Daily 6:30)
                            <br>
