    ...
    <div class="col-md-4 mx-auto">
        <div class="card">  
            ...
            <div class="card-body">
                ...
                <select class="form-control form-control-rounded" onchange="GetData(this)" name="consignee" id="basic-select">
                    <option value="" selected disabled>Select Consignee</option>
                    <?php
                        foreach($consignees->result() as $con){
                            ?>
                                <option <?= $con->CMID == $CMID ? "selected" : ""; ?> value="<?= $con->CMID; ?>"><?= $con->consigneename." (".$con->consigneecode.")" ?></option>
                            <?php
                        }
                    ?>
                </select>
